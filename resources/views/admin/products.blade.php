...
@section('title', 'AriDhi Collections - Manage Products')

@section('content')
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2"><i class="fas fa-boxes me-2"></i>Manage Products</h1>
    ...
    <div class="col-md-6 text-end">
        <div class="btn-group">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="{{ route('admin.products', ['low_stock' => 1]) }}">Low Stock</a></li>
                <li><a class="dropdown-item" href="{{ route('admin.products', ['featured' => 1]) }}">Featured</a></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    @forelse($products as $product)
                        <tr>
                            ...
                            <td>
                                ...
                                @endif
                                <!-- Removed the "New Arrival" badge as it's now handled by the category -->
                            </td>
                            <td>
