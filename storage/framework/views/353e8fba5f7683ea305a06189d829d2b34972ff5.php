    ...
    <style>
        ...
        * {
        ...
        .hero {
            ...
            width: 100%;
            height: 100vh;
            background: url('<?php echo e(asset('images/head.jpeg')); ?>') center/cover no-repeat;
            display: flex;
            align-items: center;
        ...
        .about-section {
          ...
          overflow: hidden;
          padding: 80px 0;
          background: url('<?php echo e(asset('images/25.jpg')); ?>') center/cover no-repeat;
...
<body>
    <!-- Coming Soon Popup -->
    <?php if(isset($comingSoon) && $comingSoon): ?>
    <div class="coming-soon-overlay" id="comingSoonPopup">
        <div class="coming-soon-popup">
            ...
            <?php endif; ?>
            <img src="<?php echo e(asset('images/logotm.jpeg')); ?>" alt="AriDhi Collections" class="coming-soon-logo">
    ...
    <div class="page">
        ...
        <header>
            <div class="header-container">
                <a href="<?php echo e(route('home')); ?>" class="logo-area">
                    <img src="<?php echo e(asset('images/logotm.jpeg')); ?>" alt="AriDhi Collections Logo" class="logo-img">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <div class="user-dropdown">
                            <button class="user-icon-btn" id="userDropdown">
                                <img src="<?php echo e(asset('images/icon.png')); ?>" alt="User" class="user-img">
                            </button>
                ...
                <nav class="vertical-nav">
                    <ul>
                        <?php if(auth()->guard()->check()): ?>
                            <?php if(Auth::user()->isAdmin()): ?>
                                <li><a href="<?php echo e(route('admin.index')); ?>" class="<?php echo e(request()->routeIs('admin.index') ? 'active' : ''); ?>">Dashboard</a></li>
                            <?php endif; ?>
                        <?php endif; ?>
                        ...
                        <li><a href="<?php echo e(route('products.collection')); ?>" class="<?php echo e(request()->routeIs('products.collection') ? 'active' : ''); ?>">Collection</a></li>
                        <li><a href="<?php echo e(route('products.new_arrival')); ?>" class="<?php echo e(request()->routeIs('products.new_arrival') ? 'active' : ''); ?>">New Arrivals</a></li>
                        <?php if(auth()->guard()->check()): ?>
                            <li><a href="<?php echo e(route('wishlist.index')); ?>" class="<?php echo e(request()->routeIs('wishlist.index') ? 'active' : ''); ?>">Wishlist</a></li>
                            <li><a href="<?php echo e(route('cart.index')); ?>" class="<?php echo e(request()->routeIs('cart.index') ? 'active' : ''); ?>">Cart</a></li>
                            <li><a href="<?php echo e(route('orders.index')); ?>" class="<?php echo e(request()->routeIs('orders.index') ? 'active' : ''); ?>">Orders</a></li>
                        <?php endif; ?>
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <div class="auth-buttons">
                                <a href="<?php echo e(route('login')); ?>" class="btn-auth btn-login">Login</a>
                                <a href="<?php echo e(route('register')); ?>" class="btn-auth btn-register">Register</a>
                            </div>
                        <?php endif; ?>
                    </ul>
                </nav>
        ...
        <div class="slide-menu" id="slideMenu">
            <div class="slide-menu-header">
                <div class="slide-menu-logo">
                    <img src="<?php echo e(asset('images/logotm.jpeg')); ?>" alt="AriDhi Collections Logo" class="slide-menu-logo-img">
            ...
            <?php else: ?>
                <div class="slide-auth-buttons">
                     <a href="<?php echo e(route('login')); ?>" class="btn-auth btn-login" style="height: 40px; display: flex; align-items: center;">Login</a>
                        <a href="<?php echo e(route('register')); ?>" class="btn-auth btn-register" style="height: 40px; display: flex; align-items: center;">Register</a>
                </div>
            <?php endif; ?>
        </div>
        ...
        <section class="hero">
            <div class="content">
                ...
                <a href="<?php echo e(route('products.collection')); ?>" class="btn">Explore our Collection</a>
            </div>
            <div class="image"></div>
        </section>
        ...
        <section class="why-choose-us">
          ...
          <div class="why-item">
            ...
            <div class="why-img">
              ...
              <img src="<?php echo e(asset('images/2.jpg')); ?>" alt="Premium Quality">
          ...
          <div class="why-item">
            ...
            <div class="why-img">
              ...
              <img src="<?php echo e(asset('images/8.jpg')); ?>" alt="Artisan Craftsmanship">
          ...
          <div class="why-item">
            ...
            <div class="why-img">
              ...
              <img src="<?php echo e(asset('images/12.jpg')); ?>" alt="Worldwide Delivery">
                    ...
                    <div class="carousel-wrapper">
                        <div class="carousel-track">
                            <?php if(isset($products) && $products->count() > 0): ?>
                                ...
                                <div class="carousel-slide">
                                    <div class="product-slide-card">
                                        <div class="product-slide-img" style="background-image: url('<?php echo e($product->image_url); ?>');"></div>
                                        <div class="product-slide-info">
                                            <h3 class="product-slide-title"><?php echo e($product->name); ?></h3>
                                            <a href="<?php echo e(route('products.show', $product)); ?>" class="btn btn-slide">View Details</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <?php else: ?>
                                ...
                                ?>
                                <?php $__currentLoopData = $sampleProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="carousel-slide">
                                    <div class="product-slide-card">
                                        <div class="product-slide-img" style="background-image: url('<?php echo e(asset('images/' . $product['image'])); ?>');"></div>
                                        <div class="product-slide-info">
                                            <h3 class="product-slide-title"><?php echo e($product['name']); ?></h3>
                                            <a href="<?php echo e(route('products.collection')); ?>" class="btn btn-slide">View Details</a>
                                        </div>
                                    </div>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="products-grid">
                    <?php if(isset($products)): ?>
                        ...
                        <div class="product-card">
                            <div class="product-img" style="background-image: url('<?php echo e($product->image_url); ?>');"></div>
                            <div class="product-info">
                                ...
                                <a href="<?php echo e(route('products.show', $product)); ?>" class="btn">View Details</a>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?>
                        ...
                        <?php $__currentLoopData = $sampleProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="product-card">
                            <div class="product-img" style="background-image: url('<?php echo e(asset('images/' . $product['image'])); ?>');"></div>
                            <div class="product-info">
                                <div class="product-category"><?php echo e($product['category']); ?></div>
                                <h3 class="product-title"><?php echo e($product['name']); ?></h3>
                                <div class="product-price">₹<?php echo e($product['price']); ?></div>
                                <a href="<?php echo e(route('products.collection')); ?>" class="btn">View Details</a>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
            ...
            <div class="container">
                <div class="about-content">
                    <div class="about-text">
                        ...
                        <a href="<?php echo e(route('about')); ?>" class="cta-btn">Learn More</a>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="footer-content">
                    ...
                    <div class="footer-column">
                        ...
                        <ul>
                            ...
                            <li><a href="<?php echo e(route('products.collection')); ?>">Collections</a></li>
                            <li><a href="<?php echo e(route('contact')); ?>">Contact</a></li>
                            <li><a href="<?php echo e(route('terms.conditions')); ?>">Terms & Conditions</a></li>
                            <li><a href="<?php echo e(route('refund.policy')); ?>">Return & Refund Policy</a></li>
                        </ul>
                    </div>
                    <div class="footer-column">
                        <h3>Categories</h3>
                        <ul>
                            <li><a href="<?php echo e(route('products.collection.bedsheets')); ?>">Bedsheets</a></li>
                            <li><a href="<?php echo e(route('products.collection.cushions')); ?>">Cushions</a></li>
                            <li><a href="<?php echo e(route('products.collection.rugs')); ?>">Rugs</a></li>
                            <li><a href="<?php echo e(route('products.collection.table_runners')); ?>">Table Runners</a></li>
                            <li><a href="<?php echo e(route('products.collection.new_arrivals')); ?>">New Arrivals</a></li>
                        </ul>
                    </div>
                    <div class="footer-column">
                        <h3>Contact Us</h3>
...
</html><?php /**PATH E:\my projects\aridhi\laravel\resources\views/welcome.blade.php ENDPATH**/ ?>